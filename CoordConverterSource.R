...
# Sometimes, some regular expression metacharacter 
# could appear in the DMS format (e.g. when reading data from webpages)
# here is a way to deal with that:
test <- "43°37'42\" N" 
# where seconds are identified by (\" N) or (\" W), 
# because \ is a metacharacter in regular expression,
# in R one will have to escape it like \\\\,
